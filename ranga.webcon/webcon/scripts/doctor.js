...
doctor.results = {
	...
	ISP_NK_PIN_ERROR: ["Netkeeper PIN 错误", "似乎你设置的系统时钟不对，因此无法计算正确的 PIN 码", "请检查是否为路由器设置了正确的系统时钟|如果你使用自动同步时间，请检查本地系统时钟和时区|如果你正在使用 SS-Seth 并使用了缩减版本（sdx3, sdx4 等）的数据文件，请相应等待 1，2 分钟（以此类推）后重试"],
