...
doctor.results = {
	...
	ISP_MULTIPLE_DENIED: ["拒绝单号多拨（RFC1334_PEER_MSG_UNKNOWN3）", "对方在 RFC1334 的某种协议中返回了未知且不可读的信息。无标准互联网规范保证实施一致，根据我们的使用经验猜测，这可能是由于你尝试在单一端口上尝试重复连接单一账户。", "检查接口的认证信息|检查系统日志获取信息|检查是否 ISP 出现了问题，请尝试在计算机上直接使用 ISP 的拨号工具进行拨号检查能否拨号，如果失败请联系 ISP 工单客服解决问题"],
